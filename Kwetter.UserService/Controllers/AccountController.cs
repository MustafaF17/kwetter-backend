...
namespace Kwetter.UserService.Controllers
{
    ...
    public class AccountController : ControllerBase
    {
        ...
        public AccountController(IUserRepository userRepository, IMessageProducer messageProducer)
        {
        ...
        public async Task<IActionResult> Register(RegisterDto registerDto)
        {
            ...
            UserDto userDto = new UserDto(user.Id, user.Username, user.Role, "UserCreated");

            _messageProducer.SendingMessage<UserDto>(userDto);
